...
local maybe = character.MARTILLO
...
item2:BreakJoints()
game:GetService("Players").LocalPlayer.Character.Dummy.Hammer.Transparency = 1
...
a1 = Instance.new("Attachment",character2.Dummy["Hammer"])
...
a0.Orientation = Vector3.new(-90,90,90)
