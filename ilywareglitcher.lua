    ...
    for i,v in pairs(Player.Character:GetDescendants()) do
        if v:IsA("Accessory") and v.Name == ("MeshPartAccessory") then
            local smesh = v.Handle:FindFirstChild("SpecialMesh") or v.Handle:FindFirstChild("Mesh")
            v.Name = smesh.TextureId
        end
    end
...
local Hats = {but1   = game.Players.LocalPlayer.Character:WaitForChild("rbxassetid://4458626951"),
             but2   = game.Players.LocalPlayer.Character:WaitForChild("http://www.roblox.com/asset/?id=4506940486"),
             but3   = game.Players.LocalPlayer.Character:WaitForChild("http://www.roblox.com/asset/?id=4315250791"),
             but4   = game.Players.LocalPlayer.Character:WaitForChild("http://www.roblox.com/asset/?id=4794299274"),
             but5   = game.Players.LocalPlayer.Character:WaitForChild("BladeMasterAccessory"),
             but6   = game.Players.LocalPlayer.Character:WaitForChild("ShadowBladeMasterAccessory"),
}
...
AO.Responsiveness = 10000000
end

Hats.but1.Handle.Size = Vector3.new(0.001, 0.001, 0.001)
Hats.but2.Handle.Size = Vector3.new(0.001, 0.001, 0.001)
Hats.but3.Handle.Size = Vector3.new(0.001, 0.001, 0.001)
Hats.but4.Handle.Size = Vector3.new(0.001, 0.001, 0.001)
Hats.but5.Handle.Size = Vector3.new(0.001, 0.001, 0.001)
Hats.but6.Handle.Size = Vector3.new(0.001, 0.001, 0.001)

align(Hats.but1.Handle, LWP1.Main)
align(Hats.but2.Handle, LWP2.Main)
align(Hats.but3.Handle, RWP1.Main)
align(Hats.but4.Handle, RWP2.Main)
align(Hats.but5.Handle, LWP3.Main)
align(Hats.but6.Handle, RWP3.Main)

Hats.but1.Handle.Attachment.Rotation = Vector3.new(0,0,-45)
Hats.but2.Handle.Attachment.Rotation = Vector3.new(0,0,-45)
Hats.but3.Handle.Attachment.Rotation = Vector3.new(0,0,-45)
Hats.but4.Handle.Attachment.Rotation = Vector3.new(0,0,-45)
Hats.but5.Handle.Attachment.Rotation = Vector3.new(0,0,-48)
Hats.but6.Handle.Attachment.Rotation = Vector3.new(0,0,-48)

LWP1:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"
LWP2:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"
RWP1:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"
RWP2:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"
LWP3:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"
RWP3:WaitForChild("Main"):FindFirstChild("Attachment").Name = "Attachment"

LWP1.Main.Attachment.Position = Vector3.new(0,-2,0)
LWP2.Main.Attachment.Position = Vector3.new(0,-2,0)
LWP3.Main.Attachment.Position = Vector3.new(0,-1.75,0)
RWP1.Main.Attachment.Position = Vector3.new(0,-2,0)
RWP2.Main.Attachment.Position = Vector3.new(0,-2,0)
RWP3.Main.Attachment.Position = Vector3.new(0,-1.75,0)
...
alignorien.Responsiveness = 10000
