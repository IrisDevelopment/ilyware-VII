...
local lav = char['Black Type-37 Pulse Rifle'].Handle -- hat name inside of dex
...
att1.Position = Vector3.new(0.1,-2,0) -- whatever pos u want

att1.Orientation = Vector3.new(0,-90,40) -- whatever rotation u want

att1.Parent = char["Right Arm"] -- set to where u want it welded
...
temp1.Force = Vector3.new(9000,9000,9000)
temp1.Parent = v
v.CanCollide = false

mouse.Button1Down:Connect(function()
temp.Position = mouse.Hit.p + Vector3.new(0,1.5,0)
wait(0.7)
temp.Position = plr.Character.Dummy.Torso.Position + Vector3.new(0,10,0)
end)
