...
local maybe = character["ShadowBladeMasterAccessory"]
...
character.LowerTorso.WaistBackAttachment.Position = Vector3.new(-0, -0, 0.6)
character.LowerTorso.WaistBackAttachment.Orientation = Vector3.new(-4.16, -179.28, 99.8)
else character.Torso.WaistBackAttachment.Position = Vector3.new(-0, -0, 0.6)
character.Torso.WaistBackAttachment.Orientation = Vector3.new(-4.16, -179.28, 99.8) end
...
item2:BreakJoints()
character2.Dummy.Effects["Abyssal_Sword"].Transparency = 2
...
a1 = Instance.new("Attachment",character2.Dummy.Effects["Abyssal_Sword"])
...
a0.Orientation = Vector3.new(0,0,135)
