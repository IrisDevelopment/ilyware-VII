...
--achromoonic V5.7--
--edit by TrixLua#8210--
--THERE IS NO NET SO YOU WILL HAVE TO PUT ONE IN!--
...
local modeInfo={
	...
	{Name="SANS",Walkspeed=50,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=2567531741,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarL'};
	...
	{Name="D I V I N E",Walkspeed=50,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=876488057,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};WingAnim='StarLTT'};
	...
	{Name="+EMPTY+",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=2642108668,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarEL'};
	{Name="THE DEMONITIZOR",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=5798051610,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarTE'};
	{Name="LEGMAN",Walkspeed=35,moveVal=48,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.500);Music=1214497430,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarEF'};
	...
	{Name="P O W E R",Walkspeed=27,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(174, 122, 89);Music=3080022158,LeftWing={0,BrickColor.new'Neon orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='NebG5'};
	...
	{Name="+OVERPOWERED+",Walkspeed=64,moveVal=14,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,190,190);Music=3330414980,LeftWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};WingAnim='TSI'};	
	...
	{Name="Dark Energy",Walkspeed=18,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=1842932918,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarL'};
	{Name="ROLLIN",Walkspeed=50,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=696691506,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarLTR'};
	...
	{Name="THE LAST FRAME",Walkspeed=19,moveVal=9,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,255,0);Music=999361323,LeftWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Fire Yellow'.Color,Enum.Material.Neon};WingAnim='StarLE'};
...
function changeMudo(modeName)
	...
	text.Font=info.Font;
	if(Mode=='HORROR' or Mode=='DEATH')then
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.K and Mode~='S P E E D')then 
		...
		changeMode'GOD'
	elseif(io.KeyCode == Enum.KeyCode.Y and Mode~='THE DEMONITIZOR')then 
		changeMode'THE DEMONITIZOR'
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='GL^%£ITCH')then 
		changeMode'D I V I N E'
	elseif(io.KeyCode == Enum.KeyCode.Q and Mode=='Dark Energy')then 
		changeMode'THE LAST FRAME'
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='THE DEMONITIZOR')then 
		changeMode'+EMPTY+'
...
WingAnims.StarLF=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-800*M.C(WingSine/50))),.2)
end
...
WingAnims.StarLTR=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(4,-2,-0)*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(-0*M.C(WingSine/6400000))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(2,-2,-0)*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(-0*M.C(WingSine/6400000))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(6,-2,-0)*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(-0*M.C(WingSine/6400000))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-4,-2,-0)*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(-0*M.C(WingSine/6400000))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-2,-2,-0*M.S(WingSine/35))*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(-0*M.C(WingSine/6400000))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-6,-2,-0)*CF.A(M.R(0*M.C(WingSine/32)),0,M.R(0*M.C(WingSine/6400000))),.2)
...
WingAnims.StarEL=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(60.5,-500,-100)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(60.5,-500,-100)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(60.5,-500,-100)*CF.A(M.R(15+0*M.C(WingSine/32)),0,M.R(30+9*M.C(WingSine/32))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-60.5,-500,-100)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-60.5,-500,-100+.05*M.S(WingSine/35))*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-60.5,-500,-100)*CF.A(M.R(15+0*M.C(WingSine/32)),0,M.R(-30-9*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
end
...
WingAnims.StarLTT=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(800+8000*M.C(WingSine/1520))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(30+4000*M.C(WingSine/1520))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(30+8000*M.C(WingSine/1520))),.2)
	
	RWP1W.C0 = RWP3W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-800-8000*M.C(WingSine/1520))),.2)
	RWP2W.C0 = RWP3W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-4000*M.C(WingSine/1520))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-8000*M.C(WingSine/1520))),.2)
...
WingAnims.StarTE=function()
	...
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1*M.C(WingSine/32),1.5+3*M.C(WingSine/32),-1)*CF.A(0,0,M.R(90+2.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/32),1.5-3*M.S(WingSine/32),-1)*CF.A(0,0,M.R(120-5*M.C(WingSine/32))),.2)
	...
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/32),1.5+3*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-120+5*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
end
...
if(legAnims)then 
		...
		elseif(Mode=='THE LAST FRAME')then
			local Alpha = .1
			if(NeutralAnims)then
			    			    			    				GotEffect{
					Lifetime=.5;
...
if(legAnims)then 
			...
			elseif(Mode=='THE DEMONITIZOR')then
				local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,3+1*M.C(Sine/32),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
				if(M.RNG(1,45)==1)then
  ...
  elseif(State == 'Walk')then
	  ...
	  elseif(State == 'Walk')then
		...
		if(Mode=='ROLLIN')then
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+.4*M.C(Sine/39),0+0*M.C(Sine/32),0)*CF.A(M.R(-100000000000000*M.S(Sine/6400000000000)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
